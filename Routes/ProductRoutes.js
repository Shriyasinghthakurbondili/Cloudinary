...
// router.post("/products", authMiddleware, upload.single("image"), addNewProduct )
...
// ✅ POST (IMAGE UPLOAD)
router.post("/products",authMiddleware,upload.single("image"),addNewProduct); // VERY IMPORTANT
